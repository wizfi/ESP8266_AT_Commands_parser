 ...
 * @link    
 * @license GNU GPL v3
 * @brief   Configuration for WizFi360 library
 *	
\verbatim
   ----------------------------------------------------------------------
...
\endverbatim
 */
#ifndef WizFi360_CONF_H
#define WizFi360_CONF_H 020

/**
 * @defgroup WizFi360_CONF
 * @brief    Configuration parameters for WizFi360 library
 * @{
 */
 ...
 *
 *          Size of buffer depends on speed of calling @ref WizFi360_Update function, ESP baudrate and
 *          max ESP receive string size.
 *
 * @note    When possible, buffer should be at least 1024 bytes.
 */
#define WizFi360_USARTBUFFER_SIZE                 1024
 ...
 */
#define WizFi360_TMPBUFFER_SIZE                   512
 ...
 */
#define WizFi360_USE_SINGLE_CONNECTION_BUFFER      1
 ...
 */
#define WizFi360_CONNECTION_BUFFER_SIZE             5842
 ...
 */
#define WizFi360_USE_PING                           1

/**
 * @brief   Enables (1) or disables (0) update ESP8288 AT software via network using AT commands.
 *
 *          When using WizFi360 with at least 8Mbit flash memory and proper AT software flashed on it (AT with boot support),
 *          WizFi360 can self update firmware if proper AT command is used.
 *
 *          This macro enables/disables functions for firmware updating
 */
#define WizFi360_USE_FIRMWAREUPDATE                 1
 ...
 */
#define WizFi360_USE_APSEARCH                       1

/**
 * @brief   Sets how many AP stations stack will parse which are received from WizFi360 module
 *
 *          Set to 10 by default.
 *
 * @note    @ref WizFi360_USE_APSEARCH must be enabled for this feature
 */
#define WizFi360_MAX_DETECTED_AP                    10

/**
 * @brief   Sets number of bytes each connection can use for identification name used by user when creating client connection
 *          using @ref WizFi360_CreateClientConnection.
 */
#define WizFi360_MAX_CONNECTION_NAME                32
